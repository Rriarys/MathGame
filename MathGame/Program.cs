...
Console.WriteLine($"Hello, {playerName}! Let's play the Math Game!");
Console.WriteLine
...
while (true)
    {
        ...
        Console.WriteLine("Invalid choice. Please enter a number between 1 and 5, or 9 for the story, or 0 to exit.");
    }
